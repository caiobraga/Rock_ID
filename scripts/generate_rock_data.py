...
def populate_rocks():
    ...
    rock_names = ["Adakite", "Andesite", "Alkali feldspar granite", "Anorthosite", "Aplite", "Basalt", "Pāhoehoe", "Basaltic trachyandesite", "Mugearite", "Shoshonite", "Basanite", "Blairmorite", "Boninite", "Carbonatite", "Charnockite", "Enderbite", "Dacite", "Diabase", "Diorite", "Napoleonite", "Dunite", "Essexite", "Foidolite", "Gabbro", "Granite", "Granodiorite", "Granophyre", "Harzburgite", "Hornblendite", "Hyaloclastite", "Icelandite", "Ignimbrite", "Ijolite", "Kimberlite", "Komatiite", "Lamproite", "Lamprophyre", "Latite", "Lherzolite", "Monzogranite", "Monzonite", "Nepheline syenite", "Nephelinite", "Norite", "Obsidian", "Pegmatite", "Peridotite", "Phonolite", "Phonotephrite", "Picrite", "Porphyry (geology)", "Pumice", "Pyroxenite", "Quartz diorite", "Quartz monzonite", "Quartzolite", "Rhyodacite", "Rhyolite", "Comendite", "Pantellerite", "Scoria", "Shonkinite", "Sovite", "Syenite", "Tachylyte", "Tephriphonolite", "Tephrite", "Tonalite", "Trachyandesite", "Benmoreite", "Trachybasalt", "Hawaiite", "Trachyte", "Troctolite", "Trondhjemite", "Tuff", "Websterite", "Wehrlite", "Argillite", "Arkose", "Banded iron formation", "Breccia", "Calcarenite", "Chalk", "Chert", "Claystone", "Coal", "Conglomerate (geology)", "Coquina", "Diamictite", "Diatomite", "Dolomite (rock)", "Evaporite", "Flint", "Geyserite", "Greywacke", "Gritstone", "Itacolumite", "Jaspillite", "Laterite", "Lignite", "Limestone", "Marl", "Mudstone", "Oil shale", "Oolite", "Phosphorite", "Sandstone", "Shale", "Siltstone", "Sylvinite", "Tillite", "Travertine", "Tufa", "Turbidite", "Wackestone", "Anthracite", "Amphibolite", "Blueschist", "Cataclasite", "Eclogite", "Gneiss", "Granulite", "Greenschist", "Hornfels", "Calcflinta", "Litchfieldite", "Marble", "Migmatite", "Mylonite", "Metapelite", "Protolith", "Phyllite", "Pseudotachylite", "Quartzite", "Schist", "Serpentinite", "Skarn", "Slate", "Suevite", "Talc carbonate", "Soapstone", "Tectonite", "Whiteschist", "Adamellite", "Appinite", "Aphanite", "Borolanite", "Larvikite", "Epidosite", "Felsite", "Flint", "Ganister", "Gossan", "Hyaloclastite", "Ijolite", "Jadeitite", "Jasperoid", "Kenyte", "Lapis lazuli", "Larvikite", "Litchfieldite", "Llanite", "Luxullianite", "Mangerite", "Lamprophyre", "Novaculite", "Pietersite", "Pyrolite", "Rapakivi granite", "Rhomb porphyry", "Rodingite", "Shonkinite", "Taconite", "Tachylite", "Teschenite", "Theralite", "Unakite", "Variolite", "Lamprophyre", "Wad (mineral)"]  # Add more rock names as needed
    rocks = []
