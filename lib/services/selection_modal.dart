        ...
        return Container(
          ...
          child: Row(
            ...
            children: [
              GestureDetector(
                onTap: (){
                  Navigator.push(context, PageTransition(child: SelectRockPage(is_saving_rock: true), type: PageTransitionType.bottomToTop)).then((value) => Navigator.of(context).pop());
                },
                child: Column(
